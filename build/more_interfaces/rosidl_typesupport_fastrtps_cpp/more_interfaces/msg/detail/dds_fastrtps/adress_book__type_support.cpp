...
#include "more_interfaces/msg/detail/adress_book__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const more_interfaces::msg::AdressBook & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  more_interfaces::msg::AdressBook & ros_message)
{
  // Member: first_name
  cdr >> ros_message.first_name;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_more_interfaces
max_serialized_size_AdressBook(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const more_interfaces::msg::AdressBook *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<more_interfaces::msg::AdressBook *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AdressBook__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const more_interfaces::msg::AdressBook *>(
...
{
  return max_serialized_size_AdressBook(full_bounded, 0);
}

static message_type_support_callbacks_t _AdressBook__callbacks = {
  "more_interfaces::msg",
  "AdressBook",
...
static rosidl_message_type_support_t _AdressBook__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AdressBook__callbacks,
...
{
  return &more_interfaces::msg::typesupport_fastrtps_cpp::_AdressBook__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, more_interfaces, msg, AdressBook)() {
  return &more_interfaces::msg::typesupport_fastrtps_cpp::_AdressBook__handle;
}
